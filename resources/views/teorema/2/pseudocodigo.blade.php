    <div id="pseudocodigo" class="tab-pane fade in active">
      ...
      <div class="col-md-8">
        <table class="table">
          <tr style="background: black; color: white;">
            ...
            <td>
              <b>Algoritmo:</b> ArestasArvore(Grafo $g$)
            </td>
          </tr>
          <tr  id="line1">
            <td>
          ...
          <tr id="line2">
            ...
            <td>
              <b>se</b> Tamanho(vertices) = 1 <b>então</b>
            </td>
          </tr>
          <tr id="line3">
            <td>3</td>
          ...
          <tr id="line5">
            <td>5</td>
            <td>
              &nbsp;&nbsp;&nbsp;&nbsp; $v\leftarrow$ verticeGrauUm($g$)
            </td>
          </tr>
          <tr id="line6">
            <td>6</td>
            <td>
              &nbsp;&nbsp;&nbsp;&nbsp; $h\leftarrow$ grafoSemVertice($g$,$v$)
            </td>
          </tr>
          <tr id="line7">
            <td>7</td>
            <td>
              <b>retorne</b> ($1+$ ArestasArvore($h$))
            </td>
          </tr>
          <tr id="line8">
            <td>8</td>
      ...
      <!--<form class="text-right" method="post" action="{{ URL::to('/passo/comecar-animacao') }}">-->
          <button id="comecarAnimacaoTeo2" class="btn btn-primary">
